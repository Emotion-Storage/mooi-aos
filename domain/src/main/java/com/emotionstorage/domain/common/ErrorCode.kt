...
enum class ErrorCode {
    ...
    // auth
    USER_NOT_FOUND,
    NEED_SIGN_UPALREADY_REGISTERED_WITH_GOOGLE,
    ...
    companion object {
        fun toErrorCode(code: String?): ErrorCode = values().find { it.name == code } ?: UNKNOWN
    }
}
...
//    INVALID_NICKNAME(HttpStatus.BAD_REQUEST, "닉네임은 한글 또는 영문 2~8자여야 합니다."),
//
