...
class AttendanceRepositoryImpl @Inject constructor(
    ...
    private fun buildDays(streak: Int, alreadyClaimedToday: Boolean): List<AttendanceSummary.Attendance> {
        ...
        return (1..7).map { day ->
            val status = when {
                ...
                day == nextDay -> if (alreadyClaimedToday) AttendanceSummary.AttendanceStatus.ATTENDED
                else AttendanceSummary.AttendanceStatus.TODAY
