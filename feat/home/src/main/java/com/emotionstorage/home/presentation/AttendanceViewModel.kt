...
class AttendanceViewModel @Inject constructor(
    ...
    fun tryShowOnce() = viewModelScope.launch {
    ...
    fun claimToday() = viewModelScope.launch {
    ...
    @VisibleForTesting
    fun markDialogShownTodayForTest() = viewModelScope.launch {
